      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
          ...
          <div className="text-center sm:text-left">
            <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-orange-500 to-yellow-500 inline-block text-transparent bg-clip-text">
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="text-sm sm:text-base text-white space-y-2">
              <li>
                <a 
                  href="tel:+919762914999" 
                  className="flex items-center justify-center sm:justify-start space-x-2 text-white hover:text-yellow-500 transition-colors duration-300 group"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white group-hover:text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <a 
                  href="mailto:hareramakrishnalogistic@gmail.com" 
                  className="flex items-center justify-center sm:justify-start space-x-2 text-white hover:text-yellow-500 transition-colors duration-300 group"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white group-hover:text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
